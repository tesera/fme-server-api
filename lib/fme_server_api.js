...
class FMEServerAPI {
    ...
    getJob(jobid) {
        ...
        return this.request(`/transformations/jobs/id/${jobid}`);
    }

    getJobLog(jobid) {
        jobid = encodeURIComponent(jobid);
        return this.request(`/transformations/jobs/id/${jobid}/log`);
    }

    getJobResult(jobid) {
        jobid = encodeURIComponent(jobid);
        return this.request(`/transformations/jobs/id/${jobid}/result`);
    }

    getJobRequest(jobid) {
        jobid = encodeURIComponent(jobid);
        return this.request(`/transformations/jobs/id/${jobid}/request`);
    }
